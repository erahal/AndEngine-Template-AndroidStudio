 ...
 * 
 * @see http
 *      ://cgm.cs.mcgill.ca/~godfried/teaching/cg-projects/97/Ian/algorithm2.
 *      html
 * @see http
 *      ://www.geometrictools.com/Documentation/TriangulationByEarClipping.pdf
 * 
 * @author badlogicgames@gmail.com (c) 2010 Nicolas Gramlich (c) 2011 Zynga Inc.
 * 
	...
	private static boolean isAnyVertexInTriangle(final ArrayList<Vector2> pVertices, final int[] pVertexTypes, final float pX1,
		...
		while (i < vertexCount - 1) {
			if ((pVertexTypes[i] == CONCAVE)) {
				...
				/*
				 * TODO The following condition fails for perpendicular, axis
				 * aligned triangles! Removing it doesn't seem to cause
				 * problems. Maybe it was an optimization? Maybe it tried to
				 * handle collinear pieces ?
				 */
