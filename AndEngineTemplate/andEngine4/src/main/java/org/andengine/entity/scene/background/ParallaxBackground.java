...
public class ParallaxBackground extends Background {
	...
	@Override
	public void on_Draw(final GLState pGLState, final Camera pCamera) {
		super.on_Draw(pGLState, pCamera);
		...
		for(int i = 0; i < this.mParallaxEntityCount; i++) {
			parallaxEntities.get(i).on_Draw(pGLState, pCamera, parallaxValue);
		}
	}
	...
	public static class ParallaxEntity {
		...
		public void on_Draw(final GLState pGLState, final Camera pCamera, final float pParallaxValue) {
			pGLState.pushModelViewGLMatrix();
			{
				...
				do {
					this.mAreaShape.on_Draw(pGLState, pCamera);
